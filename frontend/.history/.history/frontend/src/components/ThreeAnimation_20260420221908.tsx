...
export const ThreeAnimation = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      renderer.setClearColor(0x000000, 0); // Transparent to show normal page background
      renderer.sortObjects = false;
      renderer.domElement.style.display = 'block';
      containerRef.current.appendChild(renderer.domElement);
      console.log('Three.js renderer initialized and appended');
    ...
    const createFireTexture = () => {
      ...
      if (isDark) {
        ...
        grad.addColorStop(0.3, 'rgba(238, 247, 255, 0.8)');
        grad.addColorStop(0.6, 'rgba(238, 247, 255, 0.3)');
    ...
    const material = new THREE.PointsMaterial({
      size: CONFIG.PARTICLE_SIZE * (isDark ? 1 : 1.5),
