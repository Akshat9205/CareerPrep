...
export const DashboardPreview = () => {
  return (
    <section id="dashboard" className="relative overflow-hidden section-padding" style={{ position: 'relative', zIndex: 10 }}>
      {/* Three.js Particle Animation Background - renders behind everything */}
      <ThreeAnimation />
