...
export const Features: React.FC = () => {
  ...
  return (
    <section id="features" className="relative bg-background overflow-hidden border-t border-border/50 pt-20 pb-24">
      ...
      <div className="container-custom relative z-10 w-full h-full flex flex-col pt-10">
        ...
        <div className="text-center mb-8 h-[50vh] md:h-[60vh] flex flex-col items-center pointer-events-none">
          <div ref={headerRef} className="opacity-0 translate-y-[-20px] max-w-2xl mx-auto">
            <span className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary/10 border border-primary/20 mb-6 backdrop-blur-md">
              <span className="text-primary font-medium uppercase tracking-wider text-sm text-shadow">Platform Features</span>
            </span>
            <h1 className="text-4xl md:text-5xl font-extrabold text-foreground mb-6 leading-tight drop-shadow-xl">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed drop-shadow-md pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-20 mt-10 pointer-events-auto">
          {featuresData.map((feature, index) => (
            <motion.div
              ...
              className="glass-card hover:-translate-y-2 transition-all duration-300 rounded-3xl p-8 border border-border/50 hover:border-primary/50 group shadow-lg"
            >
