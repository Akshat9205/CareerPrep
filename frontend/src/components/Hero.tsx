...
export const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[100vh] flex items-center pt-28 pb-20"
    >
      {/* Background Effects */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="text-foreground">Master English</span>
              <br />
              <span className="text-green-500">Crack Interviews</span>
              <br />
              <span className="text-foreground">Get Internships</span>
            </h1> */}

            <p className="text-lg text-muted-foreground mb-8 max-w-lg transition-all">
              An AI-powered platform that prepares students for real-world jobs
              — English, interviews, resumes, and internships in one place.
            </p>

            {/* <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="bg-gradient-primary hover:opacity-90 text-primary-foreground shadow-lg shadow-primary/25 group transition-all"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="bg-green-500 hover:bg-green-600 text-white shadow-lg shadow-green-500/25 group transition-all"
                onClick={() => navigate("/learning")}
              >
                Start Learning
